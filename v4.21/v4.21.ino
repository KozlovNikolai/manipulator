...
int maxValue[maxMenu+1] = {0,  600,             4,                 2,      2,       4,            400,           2,       1     };   
...
void doAutoProbel(){
  switch (modeAutoProbel) {
                        ...
                        case 2: if (((micros() - stopFlow) > (sizeDot * 5)) && MorseSignal == 0 && WordCount){if(modeKeyboard==1){Keyboard.print(" ");};WordCount=0;};break;
                        case 3: if (((micros() - stopFlow) > (sizeDot * 7)) && MorseSignal == 0 && WordCount){if(modeKeyboard==1){Keyboard.print(" ");};WordCount=0;};break;
